        ...
        <div class="tabs2">
          ...
          <div class="content">
            ...
            <div class="tab-content" id="Flight">
              <form id="form_5" action="#" class="form_5" method="post" name="cancelForm" onsubmit="return formValidate()">
                    ...
                    <div class="wrapper under">
                      <div class="col1">
                        <a href="#" class="help"></a> </div>
                          ...
                          <a href="#" class="help"></a> </div>
			<br/>
			<button type="submit">Proceed <a  ></button>
			<br/><br/>
			</form>
...
<script >
        ...
        function formValidate() {
            ...
            var fname = document.forms["cancelForm"]["TicketID"].value;
						if(TicketID=="")
			{
					alert("TicketID must be filled out");
					return false;
			}
            var fname = document.forms["cancelForm"]["fromm"].value;
						if(fromm=="")
			{
			...
			var password = document.forms["cancelForm"]["to"].value;
						if(to=="")
			{
					alert("Destination must be filled out");
					return false;
			}
            var cardNumber = document.forms["cancelForm"]["numoft"].value;
						if(numoft==""|| numoft < 1 || numoft > 10)
			{
					alert("Number of tickets must be filled out");
					return false;
			}
			    var name = document.forms["cancelForm"]["name"].value;
			if(name=="")
			{
