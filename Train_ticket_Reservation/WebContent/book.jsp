        ...
        <div class="tabs2">
          ...
          <div class="content">
            <div class="tab-content" id="Flight">
              <form id="form_5" name="bookForm" class="form_5" method="post" onsubmit="return formValidate()">
                ...
                <div class="pad">
                    <div class="wrapper under">
					  ...
					  <span class="right relative"><a href="cancel.jsp" class="button1"><strong>Cancel Reservation</strong></a></span> </div>
                      <span class="right relative"><a href="update.jsp" class="button1"><strong>Update Reservation</strong></a></span> 
					  <span class="right relative" type="submit"><a type="submit" href="Payment.jsp" class="button1"><strong>Reserve</strong></a></span> 
...
<script type="text/javascript">Cufon.now();</script>
        ...
        function formValidate() {
            ...
            var fname = document.forms["bookForm"]["fromm"].value;
						if(fromm=="")
			{
			...
			var password = document.forms["bookForm"]["to"].value;
						if(to=="")
			{
					alert("Destination must be filled out");
					return false;
			}
            var cardNumber = document.forms["bookForm"]["numoft"].value;
